...
async def main():
    ...
    if get_daily_discription.is_trading_day():
        ...
        query = f"""
        Write a detailed analysis of today's market movements and their impact on yield curves.
        Include the following:
        1. Yield curve summary for {CURRENT_DATE}
...
if __name__ == "__main__":
    # Run the main function as an async function using asyncio
    asyncio.run(main())
